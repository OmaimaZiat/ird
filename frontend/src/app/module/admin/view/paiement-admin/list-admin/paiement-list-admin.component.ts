...
export class PaiementListAdminComponent implements OnInit {
   // declarations
    ...
    constructor(private datePipe: DatePipe, private paiementService: PaiementService,private messageService: MessageService,private confirmationService: ConfirmationService,private roleService:RoleService, private router: Router , private authService: AuthService
