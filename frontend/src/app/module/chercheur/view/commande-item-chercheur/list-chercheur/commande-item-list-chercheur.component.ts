...
export class CommandeItemListChercheurComponent implements OnInit {
   // declarations
    ...
    constructor(private datePipe: DatePipe, private commandeItemService: CommandeItemService,private messageService: MessageService,private confirmationService: ConfirmationService,private roleService:RoleService, private router: Router , private authService: AuthService
